...
from asso_utils import fix_x_batch,fix_y_batch
...
def get_valid_loss(model,x_develop,y_develop,batch_size=32):
    ...
    for batch in range(0,len(x_develop) ,batch_size ):
        ...
        if batch+batch_size > len(x_develop):
            ...
            batch_y=fix_y_batch(y_train[0][batch:batch+batch_size,:,:].copy(),
...
if __name__=="__main__":
    ...
    while True:
        ...
        batch_y=fix_y_batch(y_train[0][batch_i,start:end,:].copy(),
